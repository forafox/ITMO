...
import task.buildings.HouseForDinner;
...
public class Main {
    ...
    public static void main(String[] args) throws BabesNotFound {

        ClassPathXmlApplicationContext context = new ClassPathXmlApplicationContext(        //обращается к файлу, считывает и помещает бины сюда
                "applicationContext.xml"
        );

        BabesArrayWrapper babesArrayWrapper = new BabesArrayWrapper("Малышки");
        Babes babeOne=context.getBean("BabeOne", Babes.class);
        Babes babeTwo=context.getBean("BabeTwo", Babes.class);
        Babes babeThree=context.getBean("BabeThree", Babes.class);
        Babes babeFour=context.getBean("BabeFour", Babes.class);
        babeFour.say();
        babeOne.say();

        babesArrayWrapper.setGroup(babeTwo, babeThree, babeOne, babeFour);
        ...
        HouseBabes houseBabes = new HouseBabes("Дом малышек");
        HouseForDinner houseForDinner=new HouseForDinner("Дом для трапезы");
        //Spring
        context.close();
        //Spring
        ...
        System.out.println(babesArrayWrapper.getNameMale());
        ...
        System.out.println("Знайке понравилось,что у малышек " + GreenCity.Everywhere.checkClear());
        Znayka.getInstance().rejoice();
        ...
        System.out.println("Время от времени в он вылезал,и вот тут-то ему приходилось " + Znayka.getInstance().getOut());
        ...
        //
        System.out.println("Знайка " + Znayka.getInstance().walkAroundCity(bookCase, table, bed));
        //
        ...
        System.out.println("Знайка стал её распрашивать");
